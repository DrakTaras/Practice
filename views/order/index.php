...
?>
<h1 class="h3 mb-4 fw-normal text-center form-margin">Оформлення замовлення</h1>
    ...
    <form  action="" method="post">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col mb-1">
                    <label for="post_number" class="form-label">Номер відділення пошти</label>
            ...
            <div class="row">
                <div class="col mt-3 mb-3 text-center">
                    <button class="btn btn-primary w-100">Замовити</button>
                </div>
            </div>
        </div>
    </form>
