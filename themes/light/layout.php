...
<head>
    ...
    <link rel="icon" href="../../static/layout/icon.png">
...
<div class="wrapper">
    <header>
        <div class="top-row">
            <div class="logo">
                <a href="/">
                    <img src="../../static/layout/logotipe.png" width="200"/>
                </a>
            </div>
            <div class="search">
                <form action="" method="post">
                    <div class="search-module input-group rounded">
                        <input type="text" name="search" class="form-control rounded" value="<?=$_GET['search']?>" placeholder="Пошук" />
            ...
            <div class="user">
                <?php if (User::isUserAuthenticated()) : ?>
                    <a href="/user" class="btn btn-light text-dark  me-2 <?php if (User::isAdmin()) echo 'admin-label'?>">Привіт, <?=$user['firstname']?></a>
                ...
                <?php else : ?>
                    ...
                    <a href="/user/register" class="btn btn-dark">Зареєструватися</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="bottom-row">
            <ul class="modules">
                ...
                <li><a href="/product">Усі товари</a></li>
                <li><a href="/material">Матеріал</a></li>
                <li><a href="/brand">Бренди</a></li>
                <li><a href="/gender">Стать</a></li>
        ...
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item"><a href="/product" class="nav-link px-2 text-muted">Усі товари</a></li>
            ...
            <p class="text-center text-muted">© 2023 Тарас Драк</p>
        </footer>
</div>
